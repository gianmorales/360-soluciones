  ...
  <div>
    <div class="social-networks">
      ...
      <a href="https://www.facebook.com/360solucionesperu" target="_blank"
        ><svg style="width: 24px; height: 24px" viewBox="0 0 24 24" color="#3b5998">
          <path
            fill="currentColor"
      ...
      <a href="#" target="_blank"
        ><svg style="width: 24px; height: 24px" viewBox="0 0 24 24" color="#00acee">
          <path
            fill="currentColor"
      ...
      ></a>
      <a href="#" target="_blank"
        ><svg style="width: 24px; height: 24px" viewBox="0 0 24 24" color="#0e76a8">
          <path
            fill="currentColor"
