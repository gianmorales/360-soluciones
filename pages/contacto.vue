  ...
  <div>
    ...
    <div class="row d-flex justify-content-center">
      <div class="col-md-5 mt-3">
        <h5>
          <strong>email: </strong
          ><a href="mailto:rrhh@360solucionesperu.com"
        ...
        <h1>
          <a href="https://wa.me/51934256086" target="_blank"><svg
      ...
      <div class="col-md-5 d-flex justify-content-end mt-5">
        <div class="row d-flex justify-content-center">
          <form action="" class="mt-2">
            <label for="disabledTextInput" class="text-center"></label>
            <input type="text" class="input" placeholder="Nombre" name="nom" >
            ...
            <label for="disabledTextInput"></label>
            <input type="number" class="" placeholder="Telefono" >
